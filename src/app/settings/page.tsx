...
export default function SettingsIndexPage() {
  ...
  const settingsLinks = [
    ...
    },
    {
      ...
      description: "Configure print settings for tokens, prescriptions, receipts, and bills",
      href: "/settings/print",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Label Editor",
      description: "Design custom medicine labels with full control over layout and styling",
      href: "/settings/label",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
